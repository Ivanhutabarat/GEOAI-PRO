...
const refactorSwarmRoom = (filePath) => {
  ...
  const exportGateway = `
export const processIncomingData = (promptText) => {
...
refactorSwarmRoom('src/cores/live/components/Shared/SwarmRoom.tsx');
refactorSwarmRoom('src/cores/dummy/components/Shared/SwarmRoom.tsx');
